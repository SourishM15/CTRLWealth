/*
  # Initial Database Setup for Inequality Dashboard

  1. New Tables
    - `regions`: Stores region information (US and Washington State)
      - `id` (text, primary key)
      - `name` (text)
    ...
    - `metric_values`: Stores historical and forecast values
      - `id` (uuid, primary key)
