/*
  # Insert Initial Data for Inequality Dashboard

  1. Data Insertion
    - Insert regions (US and Washington State)
    - Insert metrics with descriptions and domains
    - Insert historical data (2000-2023)
